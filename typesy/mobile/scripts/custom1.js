$(document).ready(function () {      
    ...
    function init_template(){
		...
		//switch screenshots
		$(function(){
			if((navigator.platform.indexOf("iPod") != -1  || navigator.platform.indexOf("iPhone") != -1 || navigator.platform.indexOf("iPad") != -1))
			{
		...
		getPrice(offer, function (data) {
			if (data != null)
			{
				...
				if (data.message != null)
				{
					...
					{
						messageLabel.innerHTML = data.message;
						messageLabel.style.display = 'block';
					}

					if (imageCaption != null)
					{
						imageCaption.innerHTML = data.message;
