$(document).ready(function() {
	...
	$('html, .dropdown__close').on("click", function (e) {
	...
	$('[data-panel]').on("click", function () {
		...
		$('#inspector-panel-' + target).toggleClass('show');
	...
	//SCROLLBAR
	// $('.overflow-y-auto').overlayScrollbars({});
	// $('.simplebar').each(element, new SimpleBar({
	// 	autoHide: false,
	// }));
	// new SimpleBar($("#inspector-panel-backgrounds")[0], {
	// 	autoHide: false,
	// });
	...
	// 	// $("body").addClass("modal-on");
	// 	$('#modal-full-view').fadeIn().addClass("show");
	// 	modalCarousel();
	// });
});

// Array.from(document.querySelectorAll('.simplebar')).forEach(el => new SimpleBar)
